...
const Sidebar: React.FC<SidebarProps> = ({ conversations }) => {
    ...
    return (
        <aside className="w-64 bg-gray-900 p-4 flex flex-col">
            ...
            <button className="flex items-center justify-center w-full bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-2 px-4 rounded-lg transition-colors mb-6">
